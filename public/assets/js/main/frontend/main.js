...
/* harmony import */ var corejs_user_cart__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! corejs/user_cart */ "./src/assets/js/core/user_cart.js");
/* harmony import */ var img_favicon_ico__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! img/favicon.ico */ "./src/assets/img/favicon.ico");
...
var Main = function Main(element) {
  ...
  _defineProperty(this, "_setupEvents", function () {
    ...
    console.log(img_favicon_ico__WEBPACK_IMPORTED_MODULE_7__.default); //=======================================================================
    //Add to cart
    //=======================================================================
    ...
    phpPlugin.wrapper.on("submit", ".add_to_cart_frm", function (e) {
      ...
      (0,corejs_form_crud__WEBPACK_IMPORTED_MODULE_3__.Add)(data, ManageR);
        ...
        if (response.result == "success") {
          if (document.location.pathname != "/kngell_ecommerce/home/cart") {
            phpPlugin.header.find(".cart_nb_elt").html(function () {
              return response.msg[0] + parseInt(phpPlugin.header.find(".cart_nb_elt").html());
            });
          }
          ...
          if (document.location.pathname == "/kngell_ecommerce/home/cart") {
            new corejs_user_cart__WEBPACK_IMPORTED_MODULE_6__.default(phpPlugin.wrapper, phpPlugin.header)._display_cart();
          }
        }
      }
    });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/kngell_ecommerce/public/assets/img/favicon.ico");
