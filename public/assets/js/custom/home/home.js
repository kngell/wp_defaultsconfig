...
function imagesLoaded(selector) {
  ...
  return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default().all(_babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_1___default()(_context = _babel_runtime_corejs3_core_js_stable_array_from__WEBPACK_IMPORTED_MODULE_2___default()(selector)).call(_context, function (img) {
    if (img.complete) if (img.naturalHeight !== 0) return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default().resolve();else return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default().reject(img);
...
/* harmony import */ var corejs_waitfor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! corejs/waitfor */ "./src/assets/js/core/waitfor.js");
/* harmony import */ var img_banner1_cr_500x150_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! img/banner1-cr-500x150.jpg */ "./src/assets/img/banner1-cr-500x150.jpg");
/* harmony import */ var img_banner2_cr_500x150_jpg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! img/banner2-cr-500x150.jpg */ "./src/assets/img/banner2-cr-500x150.jpg");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  PhpPlugin.prototype.setupVariables = function () {
    ...
    this.topSale = _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context2 = this.element).call(_context2, "#top-sale");
    this.specialPrice = _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context3 = this.element).call(_context3, "#special-price");
    this.newPhone = _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context4 = this.element).call(_context4, "#new-phones");
    this.blog = _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context5 = this.element).call(_context5, "#blog");
  };
  ...
  PhpPlugin.prototype.setupEvents = function () {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context6 = phpPlugin.banner).call(_context6, ".owl-carousel").owlCarousel({
      dots: true,
      items: 1,
      autoplay: true
    }); //Top sales
    ...
    _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context7 = phpPlugin.topSale).call(_context7, ".owl-carousel").owlCarousel({
      loop: true,
      nav: true,
      dots: false,
      margin: 15,
    ...
    _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context8 = phpPlugin.newPhone).call(_context8, ".owl-carousel").owlCarousel({
      loop: true,
      nav: false,
      dots: true,
      margin: 15,
    ...
    _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context9 = phpPlugin.blog).call(_context9, ".owl-carousel").owlCarousel({
      loop: true,
      nav: false,
      dots: true,
      responsive: {
    ...
    function special_price() {
      return new (_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_1___default())(function (resolve, reject) {
        var _context10;

        var gridIMG = _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context10 = phpPlugin.specialPrice).call(_context10, ".grid .grid-item img");

        var elem = document.querySelector(".grid");
        (0,corejs_waitfor__WEBPACK_IMPORTED_MODULE_2__.default)(gridIMG).then(function () {
    ...
    special_price().then(function (mod) {
      ...
      _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_0___default()(_context11 = phpPlugin.specialPrice).call(_context11, ".button-group").on("click", "button", function (e) {
        e.preventDefault();
