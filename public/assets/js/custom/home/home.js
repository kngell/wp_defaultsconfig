...
document.addEventListener("DOMContentLoaded", function () {
  ...
  PhpPlugin.prototype.setupEvents = function () {
    ...
    var visitor = (0,corejs_visitors__WEBPACK_IMPORTED_MODULE_4__.get_visitors_data)().then(function (visitors_data) {
      var data = {
        url: "visitors/track",
        table: "visitors",
        ip: visitors_data.ip
      };
      (0,corejs_visitors__WEBPACK_IMPORTED_MODULE_4__.send_visitors_data)(data, manageR);
    ...
    function special_price() {
      return new Promise(function (resolve, reject) {
        ...
        (0,corejs_waitfor__WEBPACK_IMPORTED_MODULE_3__.default)(gridIMG).then(function () {
          resolve(new Isotope("#special-price .grid", {
