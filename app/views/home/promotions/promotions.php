            ...
            <div class="row product">
                <div class="col-lg-3 product-item">
                    <div class="card border-0 bg-light mb-2">
                        <div class="card-body">
                            <img src="/kngell_ecommerce/public/assets/img/DA.png" alt="" class="img-fluid img-thumbnail">
                        </div>
                    </div>
                    <h6>Energy Food</h6>
                    <p>EUR 125.39</p>
                ...
                <div class="col-lg-3 product-item thumbnail">
                    <div class="card border-0 bg-light mb-2">
                        <div class="card-body">
                            <img src="/kngell_ecommerce/public/assets/img/coaching.png" alt="" class="img-fluid img-thumbnail">
                        </div>
                    </div>
                    <h6>Energy Food</h6>
                    <p>EUR 125.39</p>
                ...
                <div class="col-lg-3 product-item">
                    <div class="card border-0 bg-light mb-2">
                        <div class="card-body">
                            <img src="/kngell_ecommerce/public/assets/img/consulting.png" alt="" class="img-fluid img-thumbnail">
                        </div>
                    </div>
                    <h6>Energy Food</h6>
                    <p>EUR 125.39</p>
                ...
                <div class="col-lg-3 product-item">
                    <div class="card border-0 bg-light mb-2">
                        <div class="card-body">
                            <img src="/kngell_ecommerce/public/assets/img/lean.png" alt="" class="img-fluid img-thumbnail">
                        </div>
                    </div>
                    <h6>Energy Food</h6>
                    <p>EUR 125.39</p>
