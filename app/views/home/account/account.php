...
<!-------Costum-------->
<link
    href="<?= $this->asset('css/custom/home/account', 'css') ?? ''?>"
                    ...
                    <div class="card-header profile-header">
                        ...
                        <div class="profile-author d-sm-flex">
                            <div class="text-center profile-photo">
                                <img src="/kngell_ecommerce/public/assets/img/profile-photo.png" alt="Profile Photo" class="img-fluid">
                            </div>
...
<script type="text/javascript"
    src="<?= $this->asset('js/custom/home/account', 'js') ?? ''?>">
</script>
<?php $this->end();
