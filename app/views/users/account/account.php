...
<!-------Costum-------->
<link
    href="<?= $this->asset('css/custom/users/account/account', 'css') ?? ''?>"
                    ...
                    <div class="card-body mini-profile-body">
                        <div class="mini-profile-title">
                            <a class="mini-profile-link" href="javascript:void(0)">
                                <p class="title lead"><i class="fas fa-info-circle fa-lg"></i>&nbsp;menu
                                </p>
                            </a>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 credit-card">
                                        <div class="single-card-info d-flex">
                                            <div class="card-icon">
                                                <img src="/kngell_ecommerce/public/assets/img/visa.png" alt="Card">
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 credit-card">
                                        <div class="single-card-info d-flex">
                                            <div class="card-icon">
                                                <img src="/kngell_ecommerce/public/assets/img/american-express.png" alt="Card">
                                            </div>
                                            <div class="card-info media-body">
                                                <h5 class="card-name">Musa Ahmed</h5>
                                                <p class="card-number">.... 4534 <span>02/20</span></p>
                                    ...
                                    <div class="col-md-4 col-sm-6 credit-card">
                                        <div class="single-card-info d-flex">
                                            <div class="card-icon">
                                                <img src="/kngell_ecommerce/public/assets/img/mastercard.png" alt="Card">
                                            </div>
                                            <div class="card-info media-body">
                                                <h5 class="card-name">Musa Ahmed</h5>
                                                <p class="card-number">.... 4534 <span>02/20</span></p>
                        ...
                        <div class="row transaction-menu">
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title"><span class="card-img-wrapper"><img
                                                    src="/kngell_ecommerce/public/assets/img/mescommandes.png" alt="Mes commandes"
                            ...
                            <div class="col-sm-6 transaction-item">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title"><span class="card-img-wrapper"><img
                                                    src="/kngell_ecommerce/public/assets/img/donnees-personnelles.png"
                            ...
                            <div class="col-sm-6 transaction-item">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title"><span class="card-img-wrapper"><img
                                                    src="/kngell_ecommerce/public/assets/img/adresses.png" alt="Mes adresses"
                            ...
                            <div class="col-sm-6 transaction-item">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title"><span class="card-img-wrapper"><img
                                                    src="/kngell_ecommerce/public/assets/img/mode-de-paiement.png"
...
<script type="text/javascript"
    src="<?= $this->asset('js/custom/users/account/account', 'js') ?? ''?>">
</script>
<?php $this->end();
