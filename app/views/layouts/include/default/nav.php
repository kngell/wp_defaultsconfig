    ...
    <div class="container-fluid">
        <div class="row myrow">
            <div class="col-md-2 logo-wrapper">
                <div class="logo pl-4 pb-4"> <a class="navbar-brand my-0 py-0" href="<?= PROOT ?>home/index"> <img
                            src="/kngell/public/assets/img/logo.png" class="img-fluid" alt="logo" title="Logo" />
            ...
            <div class="connect col-md-2">
                <?php if (!isset(UtilisateurManager::currentUser()->firstName)):?>
                <ul class="navbar">
                    <li class="connexion">
                        <a class="nav-link dropdown-toggle" data-toggle="modal" data-target="#login-box"
                            href="<?=PROOT?>users/ajaxLogin">
                ...
                <ul class="navbar">
                    <li class="nav-item dropdown menu-user ml-auto connexion">
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown"
                            role="button">
                            <span
                                class="icon login"></span>&nbsp;&nbsp;<?= 'Bonjour&nbsp;' . UtilisateurManager::currentUser()->lastName;?>
                        </a>
