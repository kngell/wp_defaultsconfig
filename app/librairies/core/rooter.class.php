...
class Rooter
{
    ...
    public function __construct()
    {
        ...
        if (file_exists(in_array($this->_controller_Name, ['AuthController', 'LoginController']) ? CONTROLLER . 'auth' . DS . strtolower($this->_controller_Name) . '.class.php' : CONTROLLER . strtolower($this->_controller_Name) . '.class.php')) {
