        ...
        <div class="page-content py-5">
            <div class="navigation">
                ...
                <div class="tab-control">
                    <a href="" class="previous-btn" role="button"><i class="fa fa-angle-left fa-3x fa-fw"></i></a>
                    <a href="" class="next-btn" role="button"><i class="fa fa-angle-right fa-3x fa-fw"></i></a>
                </div>
            </div>
            <div class="tab-content shadow-none px-0">
                <div class="tab-pane show active" id="order-information">
                                                ...
                                                <tr class="product-line">
                                                    <td class="p-cell p-img">
                                                        <div class="product-thumbnail-wrapper mt-2">
                                                            <img alt="Product"
                                                                src="<?=ImageManager::asset_img('products/product-80x80.jpg')?>"
                                                                class="img-thumbnail" width="48">
                                                            <span class="product-thumbnail-quantity">2</span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="p-cell p-price">$39.98</td>
                                                </tr>
                                                <tr class="product-line">
                                                    <td class="p-cell p-img">
                                                        <div class="product-thumbnail-wrapper mt-2">
                                                    ...
                                                    <td class="p-cell p-price">$21.99</td>
                                                </tr>
                                                <tr class="product-line">
                                                    <td class="p-cell p-img">
                                                        <div class="product-thumbnail-wrapper mt-2">
                                                    ...
                                                    <td class="p-cell p-price">$80.97</td>
                                                </tr>
                                        ...
                                        <table class="table table-borderless text-end mb-0">
                                            <tbody>
                                                <tr class="sub-total">
                                                    ...
                                                    <td class="amount">$142.94</td>
                                                </tr>
                                                <tr class="remise">
                                                    <td class="title">Remise HT:</td>
                                                    <td class=amount>$50.94</td>
                                                </tr>
                                                <tr class="tva">
                                                    <td class="title">Tax / TVA :</td>
                                                    <td class="amount">$42.94</td>
                                                </tr>
                                                <tr class="delivery">
                                    ...
                                    <form class="form g-3 needs-validation" novalidate>
                                        <div class="d-flex mt-2 justify-content-between form-title">
                                            ...
                                            <div class="account-request">
                                                ...
                                                <a class="text-highlight" href="#">Login</a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                        ...
                        <div class="col-lg-4 order-summary">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="code-achat">
                                        <div class="input-box">
                                            <input type="text" class="form-control input-box__input" id="code-achat"
                                                placeholder=" ">
                                            <label for="code-achat" class="input-box__label">
                                                Code Promo Achats
                                            </label>
                                        </div>
                                        <button class="code-achat__btn" type="button">Valider</button>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4 button-group">
                                        <div class="col-6">
                                            <a href="#order-information" class="back-to">
                                                <i class="fal fa-angle-double-left"></i>
                                                &nbsp;Back to Information
                                            </a>
                                        </div>
                        ...
                        <div class="col-lg-4 order-summary">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="code-achat">
                                        <div class="input-box">
                                            <input type="text" class="form-control input-box__input" id="code-promo2"
                                                placeholder=" ">
                                            <label for="code-promo2" class="input-box__label">
                                                Code Promo Achats
                                            </label>
                                        </div>
                                        <button class="code-achat__btn" type="button">Valider</button>
                        ...
                        <div class="col-lg-8 order-details">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4 button-group">
                                        <div class="col-6">
                                            <a href="shopping-card.html" class="back-to">
                                                <i class="fal fa-angle-double-left"></i>&nbsp;
                                                Return to shipping
                                            </a>
                                        </div>
